...
#SBATCH --job-name=3Ddna.erc2                         # Job name
...
#SBATCH --output=3D-DNA_NS_parallel_%j.log                        # Standard output and error log
...
cd $WORKSPACE/Data/Myzus/Hi-C_Dec_2019/NS/Hi_C/test/NS2/3D_DNA_erc2
...
TMPDIR=/nobackup/beegfs/workspace/ks575/Data/Myzus/Hi-C_Dec_2019/NS/Hi_C/test/NS2/3D_DNA_erc2/tmp
TMP=$TMPDIR
TEMP=$TMPDIR
export TMPDIR TMP TEMP
run-asm-pipeline.sh --editor-repeat-coverage 2 $work_dir/references/draft.fa $WORKSPACE/Data/Myzus/Hi-C_Dec_2019/NS/Hi_C/test/NS2/aligned/merged_nodups.txt
